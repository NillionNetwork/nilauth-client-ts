...
After installing dependencies, set up git hooks: `pnpm install-hooks`
...
This library can be published as a [package on npmjs](https://www.npmjs.com/package/@nillion/nilauth-client) via the GitHub Actions workflow.
